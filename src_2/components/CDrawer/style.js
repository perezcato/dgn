...
export default styles = {
  ...
  container_navItemStyle: { flexDirection: 'row', alignItems: 'center', height: Device.h_scale('6.19%') },
  ...
  navItemStyle: { color: 'black', fontSize: Device.fS(12), fontFamily: Device.fontSlabRegular },
