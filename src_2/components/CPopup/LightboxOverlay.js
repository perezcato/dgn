...
import { Animated, Dimensions, Modal, PanResponder, Platform, StatusBar, StyleSheet, TouchableOpacity, View } from 'react-native';
        ...
        const header = (<Animated.View style={[styles.header, lightboxOpacityStyle]}>{(renderHeader ?
            ...
            (
                <TouchableOpacity onPress={this.close}>
                    <Icon name={Config.ico_back} size={25} color={'white'} type={'light'} />
                </TouchableOpacity>
            )
        )}</Animated.View>);
        const content = (
